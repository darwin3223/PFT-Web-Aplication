...
@Stateless
@NoArgsConstructor
public class SemestreDAO implements SemestreRepository {
	...
	public List<Semestre> getAll() {
		TypedQuery<Semestre> query = em.createQuery("SELECT u FROM Semestre u ORDER BY u.idSemestre ASC", Semestre.class);
...
//	    // Realiza una unión (join) con la lista de eventos de cada semestre.
//	    raizSemestre.join("eventos", JoinType.LEFT);
