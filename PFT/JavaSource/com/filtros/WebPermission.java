...
/**
 * La clase WebPermission representa los permisos de acceso para diferentes tipos de usuarios en una aplicación.
 */
@Getter
@Setter
public class WebPermission {
     ...
     * @return el objeto WebPermission actualizado
     */
    public WebPermission add(TipoUsuario tipoUsuario) {
     ...
     * @return el objeto WebPermission actualizado
     */
    public WebPermission addEstudiante() {
     ...
     * @return el objeto WebPermission actualizado
     */
    public WebPermission addAnalista() {
